...
public class frm_profesores extends javax.swing.JFrame {
private static final String INSERTAR ="{call aplicacion.insertar_profe(?,?,?,?,?,?,?)}";
private static final String VER = "{? = call aplicacion.verprofesor}";
private static final String BORRAR ="{call aplicacion.eliminar_pro(?)}";
private static final String MODIFICAR ="{call aplicacion.modificar_pro(?,?,?,?,?,?,?)}";
Conexionproyecto conexion = new Conexionproyecto();
String ced;
    /**
     * Creates new form frm_profesores
     */
    public frm_profesores() {
        initComponents();
        mostrar();
        this.setTitle("MENU DE PROFESORES");
    }
    ...
    public void mostrar(){
        ...
        tab_estudiant.addColumn("Cedula");
        ...
        tab_estudiant.addColumn("Especialidad");
...
;        try{
    ...
    private void initComponents() {
        ...
        lbl_esp = new javax.swing.JLabel();
        ...
        jLabel3.setText("Ingresar y modificar profesor");

        txt_esp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_espActionPerformed(evt);
            }
        });

        lbl_esp.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lbl_esp.setText("Especialidad");
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lbl_esp, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addGap(31, 31, 31)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addComponent(txt_esp, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lbl_fecn1, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lbl_titulo.setText("Eliminar Profesor");
        ...
        jLabel1.setText("Verifique bien el numero de cedula del profesor antes de eliminar.");
        ...
        jLabel2.setText("Ver la lista de profesores actualizada");

        jLabel5.setText("Eliminar un profesor a partir de la cedula");

        jLabel6.setText("insertar nuevos profesores y modificar profesores actuales");
    ...
    private void btn_modificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificaActionPerformed
        ...
        try{
            ...
            obj.setIdprofesor(Integer.parseInt( txt_cedula2.getText()));
            obj.setNombre(txt_nombre1.getText());
            obj.setApellidos(txt_apellido2.getText());
            obj.setGenero(txt_genero1.getText());
            obj.setFechanac(txt_fecnac1.getText());
            obj.setCorreo( txt_correo1.getText());
            obj.setEspecialidad(txt_esp.getText());

            CallableStatement  sentencia = conexion.conectar().prepareCall(MODIFICAR);
            sentencia.setInt(1, obj.getIdprofesor());
            sentencia.setString(2, obj.getNombre());
            sentencia.setString(3, obj.getApellidos());
            sentencia.setString(4, obj.getFechanac());
            sentencia.setObject(5, obj.getCorreo());
            sentencia.setString(6, obj.getGenero());
            sentencia.setString(7, obj.getEspecialidad());

            if (sentencia.executeUpdate()>0){
                JOptionPane.showMessageDialog(null,"La información del profesor fue actualizada correctamente");
            }else{
                JOptionPane.showMessageDialog(null,"No fue encontrado el profesor para actualizarlo");
            }
            limpiaCajasDeTexto1();
            mostrar();
    ...
    private void btn_insertaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_insertaActionPerformed
        ...
        try{
            ...
            if (sentencia.executeUpdate()>0){
                ...
                JOptionPane.showMessageDialog(null,"No se pudo ingresar el profesor");
            }
    ...
    private void txt_espActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_espActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_espActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_profesores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_profesores().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lbl_esp;
