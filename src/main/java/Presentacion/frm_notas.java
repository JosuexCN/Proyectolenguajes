...
private static final String INSERTAR ="{call aplicacion.insertar_notas(?,?,?,?,?)}";
private static final String VER = "{? = call aplicacion.vernotas}";
private static final String VER1 = "{? = call aplicacion.vernotaestu(?)}";
private static final String BORRAR ="{call aplicacion.eliminar_notas(?)}";
private static final String MODIFICAR ="{call aplicacion.modificar_notas(?,?,?,?,?)}";
...
String ced1;
    ...
    public void mostrar(){
        ...
        tab_estudiant.addColumn("ID Nota");
        tab_estudiant.addColumn("ID estudiante");
        tab_estudiant.addColumn("ID profesor");
        tab_estudiant.addColumn("ID materia");
        tab_estudiant.addColumn("Calificacion");
    ...
    private void initComponents() {
        ...
        lbl_genero1.setText("ID Profesor");

        lbl_apellido2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lbl_apellido2.setText("ID Materia");
        ...
        jLabel3.setText("Ingresar y modificar Nota");
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(lbl_genero1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addComponent(txt_nota, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setText("Ver la lista de notas actualizada");
        ...
        jLabel5.setText("Eliminar una nota a partir del id");

        jLabel6.setText("insertar nuevas notas y modificar notas actuales");
        ...
        lbl_cedula.setText("ID de nota");

        lbl_titulo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_titulo.setText("Eliminar Nota");
        ...
        btn_aceptar2.setForeground(new java.awt.Color(0, 204, 255));
        ...
        lbl_titulo1.setText("Buscar nota de estudiante");

        lbl_cedula1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbl_cedula1.setText("Cedula de estudiante");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbl_cedula, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txt_estudiante, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btn_aceptar2, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbl_titulo1, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lbl_titulo))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lbl_cedula)
                    .addComponent(lbl_cedula1, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
    ...
    private void btn_modificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificaActionPerformed
        ...
        try{
            ...
            obj.setIdnota(Integer.parseInt( txt_cedula2.getText()));
            obj.setIdestudiante(Integer.parseInt( txt_nombre1.getText()));
            obj.setIdprofesor(Integer.parseInt( txt_genero1.getText()));
            obj.setIdmateria(Integer.parseInt( txt_apellido2.getText()));
            obj.setNota(Integer.parseInt( txt_nota.getText()));

            CallableStatement  sentencia = conexion.conectar().prepareCall(MODIFICAR);
            sentencia.setInt(1, obj.getIdnota());
            sentencia.setInt(2, obj.getIdestudiante());
            sentencia.setInt(3, obj.getIdprofesor());
            sentencia.setInt(4, obj.getIdmateria());
            sentencia.setInt(5, obj.getNota());
    ...
    public void limpiaCajasDeTexto2(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_notas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
