...
public class frm_materia extends javax.swing.JFrame {
private static final String INSERTAR ="{call aplicacion.insertar_materia(?,?,?,?)}";
private static final String VER = "{? = call aplicacion.vermaterias}";
private static final String BORRAR ="{call aplicacion.eliminar_materia(?)}";
private static final String MODIFICAR ="{call aplicacion.modificar_materia(?,?,?,?)}";
Conexionproyecto conexion = new Conexionproyecto();
String ced;

    /**
     * Creates new form frm_materia
     */
    public frm_materia() {
        initComponents();
        this.setTitle("MENU DE MATERIAS");
        mostrar();
...
;        try{
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingresar y modificar materia");
        ...
        jLabel2.setText("Ver la lista de materias actualizada");
        ...
        jLabel5.setText("Eliminar una materia a partir del id");

        jLabel6.setText("insertar nuevas materias y modificar materias actuales");
        ...
        lbl_cedula.setText("ID de materia");

        lbl_titulo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_titulo.setText("Eliminar Materia");
    ...
    private void btn_aceptar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptar1ActionPerformed
        ...
        try{
            ...
            if (consulta.executeUpdate()>0){
                JOptionPane.showMessageDialog(null,"Los datos de la materia fueron borrados de la base de datos");
            }else{
                JOptionPane.showMessageDialog(null,"No fue encontrada el id de la materia en la base de datos");
            }
    ...
    private void btn_insertaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_insertaActionPerformed
        ...
        try{
            ...
            obj.setIdmateria(Integer.parseInt( txt_cedula2.getText()));
            obj.setNombre(txt_nombre1.getText());
            obj.setTipo(txt_genero1.getText());
            obj.setPrecio(Integer.parseInt( txt_apellido2.getText()));

            CallableStatement  sentencia = conexion.conectar().prepareCall(INSERTAR);

            sentencia.setInt(1, obj.getIdmateria());
            sentencia.setString(2, obj.getNombre());
            sentencia.setString(3, obj.getTipo());
            sentencia.setInt(4, obj.getPrecio());
    ...
    private void btn_modificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificaActionPerformed
        ...
        try{
            ...
            if (sentencia.executeUpdate()>0){
                JOptionPane.showMessageDialog(null,"La información de la materia fue actualizada correctamente");
            }else{
                JOptionPane.showMessageDialog(null,"No fue encontrado la materia para actualizarlo");
            }
            limpiaCajasDeTexto1();
            mostrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_materia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_materia().setVisible(true);
            }
        });
    }
